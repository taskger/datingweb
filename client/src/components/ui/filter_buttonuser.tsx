  ...
  return (
    ...
    {props.data.map((value,index) => {
      ...
      <div className=' absolute w-20 h-20'>
        <Image src={value.image && value.image !== '' ? `${value.image}?t=${Date.now()}` : '/user.png'} width={50} height={50} alt={`userimage`} className='shadow-2xl w-full h-full rounded-full ring-3 ring-white'/>
