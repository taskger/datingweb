  ...
  return (
    ...
    {props.data.map((value,index) => {
      ...
      <div className=' absolute w-20 h-20'>
        <Image src={value.image && value.image !== '' ? `${value.image}?v=${new Date().getTime()}` : '/user.png'} width={96} height={96} alt={`userimage`}  className='shadow-2xl w-full h-full object-cover rounded-full ring-3 ring-white'/>
